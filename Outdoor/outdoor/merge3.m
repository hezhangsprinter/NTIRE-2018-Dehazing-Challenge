...
list_all=dir('./our_cvprw_testpatch/*png');
image_index=1;

folder_name='./our_cvprw_test2/';
...
for i=1:7
    img1=imread(['./our_cvprw_testpatch/',num2str(image_index-1),'.png']);
...
size_all=[3533,3574;3533,3102;2679,3670;2842,3916;3362,3506];
    ...
    imwrite(img1, ['./our_cvprw_test2/',num2str(all_index+25),'.png']);
