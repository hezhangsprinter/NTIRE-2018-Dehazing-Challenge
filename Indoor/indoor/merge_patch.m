...
list_all=dir('./our_cvprw_test2/*png');
image_index=1;

folder_name='./our_cvprw_test2sub/';
...
for all_index=1:5
image1=zeros(1024,2048,3,5);

for i=1:5
    img1=imread(['./our_cvprw_test2/',num2str(image_index-1),'.png']);
...
zz3=zeros(1024,2048,3,8);

folder=cell(1,8);
for index=1:8
    start2=256*(index-1)+1;
    zz4=zz2(1:1024,start2:start2+255,1:3)/ratio(index);
    zz3(1:1024,start2:start2+255,1:3,index)=zz4;
end
...
size_all=[2882,4476;2902,4086;3052,4706;3122,4576;3122,4776];
    ...
    imwrite(img1, ['./our_cvprw_test2sub/',num2str(all_index+25),'.png']);
